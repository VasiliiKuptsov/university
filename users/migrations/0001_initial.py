    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, help_text='заеруъите аватар', null=True, upload_to='users/avatars', verbose_name='Аватар')),
                ('phone', models.PositiveIntegerField(blank=True, null=True, verbose_name='Телефон')),
                ('city', models.CharField(blank=True, help_text='Ввелите страну', max_length=35, null=True, verbose_name='город')),
                ('last_login', models.DateTimeField(blank=True, default=datetime.datetime.now, null=True, verbose_name='Время последнего посещения')),
